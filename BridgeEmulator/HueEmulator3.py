...
app = Flask(__name__, template_folder='flaskUI/templates',static_url_path="/static", static_folder='flaskUI/assets')
api = Api(app)
...
def main():
    ...
    # Initialize LIFX Native protocol with keep-alive for existing devices
    try:
        from lights.protocols import lifx_native
        lifx_native.initialize_lifx()
    except Exception as e:
        logging.debug(f"LIFX Native initialization error: {e}")
